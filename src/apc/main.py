...
from apc.collect import collect
from apc.llm_config import configure_cmd, models_cmd
from apc.mcp import mcp
from apc.memory import memory
from apc.share import install, marketplace
from apc.skill import skill
from apc.status import status
from apc.sync_helpers import count_installed_skills, resolve_target_tools, sync_all
from apc.ui import (
    cache_summary_table,
    header,
    info,
